...
exports.MinimalistNFTWrapper = void 0;
const MinimalistNFTJSON = __importStar(require("../../../build/contracts/MinimalistNFT.json"));
const DEFAULT_SEND_OPTIONS = {
    gas: 6000000
};
class MinimalistNFTWrapper {
    constructor(web3) {
        this.web3 = web3;
        this.contract = new web3.eth.Contract(MinimalistNFTJSON.abi);
    }
    get isDeployed() {
    ...
    async awardItem(player, tokenURI) {
        const value = await this.contract.methods.awardItem(player, tokenURI).call();
        return value;
    }
    async setTransferNFT(fromAddress, toAddress, tokenID) {
    ...
    async deploy(fromAddress) {
        const deployTx = await this.contract
            .deploy({
            data: MinimalistNFTJSON.bytecode,
            arguments: []
        })
            .send({
            ...DEFAULT_SEND_OPTIONS,
...
exports.MinimalistNFTWrapper = MinimalistNFTWrapper;
//# sourceMappingURL=MinimalistNFTWrapper.js.map