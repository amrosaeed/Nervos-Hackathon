...
import * as MinimalistNFTJSON from '../../../build/contracts/MinimalistNFT.json';
...
export class MinimalistNFTWrapper {
    web3: Web3;
    ...
    constructor(web3: Web3) {
        this.web3 = web3;
        this.contract = new web3.eth.Contract(MinimalistNFTJSON.abi as any) as any;
    }
