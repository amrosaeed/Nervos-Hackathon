...
import { MinimalistNFTWrapper } from '../lib/contracts/MinimalistNFTWrapper';
...
export function App() {
    ...
    const [contract, setContract] = useState<MinimalistNFTWrapper>();
    ...
    async function deployContract() {
        const _contract = new MinimalistNFTWrapper(web3);
